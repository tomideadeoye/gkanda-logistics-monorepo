...
def generate_svg_from_mermaid(mermaid_code, output_path):
    """Generate SVG from mermaid code using mermaid CLI via npx"""
    try:
        ...
        # Use npx to run mermaid CLI directly (without global installation) with config
        ...
        print("SVG generation timed out")
        return False
