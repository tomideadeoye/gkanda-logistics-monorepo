...
```mermaid
graph TD
    A[PLAN<br/>Identify objectives<br/>and processes] --> B[DO<br/>Implement the<br/>processes]
    B --> C[CHECK<br/>Monitor and measure<br/>performance]
    C --> D[ACT<br/>Take corrective<br/>actions]
    D --> A
...
```mermaid
graph TD
    A[Policy<br/>Commitment to<br/>responsibility] --> B[Risk Identification<br/>Understanding<br/>environmental & social risks]
    B --> C[Management Programs<br/>Actions to address<br/>identified risks]
    C --> D[Organizational Capacity<br/>Building internal<br/>capabilities]
    D --> E[Emergency Preparedness<br/>Preparing for<br/>emergencies]
    E --> F[Stakeholder Engagement<br/>Communicating with<br/>stakeholders]
    F --> G[External Communications<br/>Handling external<br/>communications]
    G --> H[Ongoing Reporting<br/>Keeping communities<br/>informed]
    H --> I[Monitoring & Review<br/>Measuring performance<br/>& improving system]
    I --> A
...
: Energy consumption, water usage, waste generation
...
- Regular physical walk
- throughs of our facilities and surrounding areas to observe
:
...
```mermaid
flowchart TD
    A[Identify Risk] --> B[Assess Likelihood<br/>1-5 Scale]
    A --> C[Assess Consequence<br/>1-5 Scale]
    B --> D[Calculate Risk Score<br/>Likelihood × Consequence]
    C --> D
    D --> E{Score Range?}
    E -->|1-5| F[Low Risk<br/>Monitor]
    E -->|6-12| G[Medium Risk<br/>Control Measures]
    E -->|13-25| H[High Risk<br/>Immediate Action]

    style A fill:#FFF3CD,stroke:#856404
    style F fill:#D1ECF1,stroke:#0C5460
    style G fill:#FFF3E0,stroke:#856404
...
- Multiple channels for submitting grievances (phone, email, website, in
- person, anonymous)
...
```mermaid
graph TD
    A[GK & A Logistics<br/>Services Ltd] --> B[NPA<br/>Ports Authority]
    A --> C[NIWA<br/>Inland Waterways]
    A --> D[NIMASA<br/>Maritime Safety]
    A --> E[NSC<br/>Shippers Council]
    A --> F[NESREA<br/>Environment]
    A --> G[NCS<br/>Customs Service]
    A --> H[SON<br/>Standards Org]

    B --> I[Port Operations<br/>Security<br/>Infrastructure]
    C --> J[Waterway Management<br/>Navigation Safety<br/>Vessel Licensing]
    D --> K[Maritime Safety<br/>Vessel Registration<br/>Marine Environment]
    E --> L[Economic Regulation<br/>Tariff Control<br/>Trade Facilitation]
    F --> M[Environmental Compliance<br/>Pollution Control<br/>Impact Assessment]
    G --> N[Customs Clearance<br/>Trade Compliance<br/>Revenue Collection]
    H --> O[Quality Standards<br/>Certification<br/>Product Standards]
...
- **Role**
: Federal government agency responsible for overseeing and managing all seaports and inland ports in Nigeria
...
- **Role**
: Regulatory authority for inland waterways transportation and infrastructure
...
- **Role**
: Apex regulatory and promotional maritime agency responsible for maritime safety, security, and environmental protection
...
- **Role**
: Port economic regulator in the Marine and Blue Economy sector
...
- **Role**
: Primary environmental regulatory agency responsible for enforcing environmental standards and regulations
...
- **Role**
: Oversees environmental policy and coordinates environmental management across Nigeria
...
- **Role**
: Federal agency responsible for customs administration and border control
...
- **Role**
: National standards body responsible for standardization, metrology, and quality assurance
