...
def convert_md_to_pdf_with_nodejs_npx(md_file_path, pdf_output_path):
    """Convert Markdown to PDF using Node.js and npx puppeteer with debugging"""
    ...
    async function convertToPDF(inputPath, outputPath) {
        ...
        console.log(`Read markdown content: ${mdContent.length} characters`);
...
def main():
    ...
    handbook_pdf = os.path.join(base_dir, "temp_handbook_nodejs_npx_debug.pdf")

    # Final merged output
    final_pdf = os.path.join(base_dir, "GK_and_A_Logistics_ESMS_Handbook_Debug.pdf")
