...
<div style="text-align: center; margin: 30px auto; width: 100%;">
    <div style="display: inline-block; text-align: center; width: 100%; max-width: 800px;">
        <img src="diagrams/diagram_1_optimized.png" alt="Diagram 1" style="max-width: 100%; height: auto; margin: 0 auto; display: block;">
...
<div style="text-align: center; margin: 30px auto; width: 100%;">
    <div style="display: inline-block; text-align: center; width: 100%; max-width: 800px;">
        <img src="diagrams/diagram_2_optimized.png" alt="Diagram 2" style="max-width: 100%; height: auto; margin: 0 auto; display: block;">
        <p style="margin-top: 10px; font-style: italic; text-align: center;">Diagram 2</p>
    </div>
</div>
...
<div style="text-align: center; margin: 30px auto; width: 100%;">
    <div style="display: inline-block; text-align: center; width: 100%; max-width: 800px;">
        <img src="diagrams/diagram_3_optimized.png" alt="Diagram 3" style="max-width: 100%; height: auto; margin: 0 auto; display: block;">
        <p style="margin-top: 10px; font-style: italic; text-align: center;">Diagram 3</p>
    </div>
</div>
...
<div style="text-align: center; margin: 30px auto; width: 100%;">
    <div style="display: inline-block; text-align: center; width: 100%; max-width: 800px;">
        <img src="diagrams/diagram_4_optimized.png" alt="Diagram 4" style="max-width: 100%; height: auto; margin: 0 auto; display: block;">
        <p style="margin-top: 10px; font-style: italic; text-align: center;">Diagram 4</p>
    </div>
</div>
